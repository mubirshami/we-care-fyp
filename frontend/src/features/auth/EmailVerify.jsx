    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-neutral-500 leading-relaxed">
          Your email address has been confirmed. You're all set — sign in to start your wellness
          journey.
        </p>
      </div>
      <Link
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-neutral-500 leading-relaxed">
          This verification link has expired or has already been used. Verification links are valid
          for 24 hours.
        </p>
      </div>
